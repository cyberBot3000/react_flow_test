      ...
      <div className={styles.childrenWrapper}>
        <div className={styles.groupNodeRoot}>
          ...
          <div className={styles.groupNodeRootActions}>
            <button
              className={styles.groupNodeRootActionButton}
              onClick={() => data.collapse(id, !data.isCollapsed)}
            >
              ⌄
            </button>
            {!data.isCollapsed && (
              <button
                className={styles.groupNodeRootActionButton}
                onClick={() => data.addEmptyNode(id, -2, 0, true)}
              >
                +
              </button>
            )}
          ...
          <Handle
            ...
            id="inner-source"
            className={styles.innerSourceHandle}
          />
        </div>
        <Handle
          type="source"
          position={Position.Right}
          id="outer-source"
          className={styles.outerSourceHandle}
        />
      </div>
    </div>
  );
